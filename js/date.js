...
// Функция addLeadingZero, добавляющая ведущий ноль (перобразует число в строку)
...
function getUserTime(t) {
	...
	let Y = t.getFullYear();
	// Извлекаем месяц (М = Month) т.к. значения выводятся c 0 до 11
	let M = t.getMonth();
	...
	/*
	В результате в переменную z записывается не порядковый номер дня недели,
	а его название, взятое из массива. 
	Важно! Записывая объект с методом в [] мы получаем доступ к элементу массива по его позиции начиная с 0.
